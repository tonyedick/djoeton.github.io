                        ...
                        <Row>
                                ...
                                <Col lg={6} md={6} sm={12} className="mt-5">
                                    <div className="course-paths">
                                        ...
                                        <p className="cardSubTitle text-justify"><FontAwesomeIcon className="iconBullent" icon={faCheckSquare} /> Introduction to Content Writing </p>

                                        <p className="cardSubTitle text-justify"><FontAwesomeIcon className="iconBullent" icon={faCheckSquare} /> Online resources</p>

                                        <p className="cardSubTitle text-justify"><FontAwesomeIcon className="iconBullent" icon={faCheckSquare} /> Story telling foundation</p>

                                        <p className="cardSubTitle text-justify"><FontAwesomeIcon className="iconBullent" icon={faCheckSquare} /> Content Writing Deep Dive </p>
