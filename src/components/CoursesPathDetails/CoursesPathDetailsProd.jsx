...
class CoursesPathDetailsProd extends Component {
        render() {
            return(
                <Fragment>
                   ...
                   <Row>
                                <Col lg={8} md={6} sm={12}>
                                    ...
                                    <br></br> <br></br>
                                    <p className="CoruseallDescription">This is your first step to becoming a professional Product Designer. Get industry experience when you learn from Top Product Designers in the industry alongside students from over 150 countries.</p>
                                </Col>
...
export default CoursesPathDetailsProd
