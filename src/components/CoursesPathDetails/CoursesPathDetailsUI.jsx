...
class CoursesPathDetailsUI extends Component {
        render() {
            return(
                <Fragment>
                   ...
                   <Row>
                                <Col lg={8} md={6} sm={12}>     
                                    ...
                                    <br></br> <br></br>
                                    <p className="CoruseallDescription">This is your first step to becoming a professional UI/UX designer. Get industry experience when you learn from Top UI/UX Professionals in the industry alongside students from over 150 countries.</p>
                                </Col>
                            ...
                            <Col className="mt-5 requirements" lg={8} md={6} sm={12}>
                                <div>
                                    ...
                                    <ul>
                                        ...
                                        <li><FontAwesomeIcon className="iconBullent" icon={faCheckSquare} /> Design System</li>

                                        <li><FontAwesomeIcon className="iconBullent" icon={faCheckSquare} /> AdobeXD Deep Dive/Figma</li>
...
export default CoursesPathDetailsUI