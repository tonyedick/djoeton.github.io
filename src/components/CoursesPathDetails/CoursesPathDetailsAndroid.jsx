            ...
            return(
                <Fragment>
                   <Container className="mt-5">                        
                        <Row>
                                <Col lg={8} md={6} sm={12}>     
                                    <h1 className="coursePathsText">Become a Professional Android Developer</h1>
                                    <img className="androidDetaisImg" src="https://solverwp.com/demo/html/edumint/assets/img/course/9.png" alt=""/>
                                    <br></br> <br></br>
                                    <p className="CoruseallDescription">Join fellow students like you and kick start your career in the Top 10% Career Jobs of the Future, when you register with SojiLearn. Course Modules.</p>
                                </Col>
                            ...
                            <Col className="mt-5 requirements" lg={8} md={6} sm={12}>
                                <div>
                                    ...
                                    <ul>
                                        ...
                                        <li><FontAwesomeIcon className="iconBullent" icon={faCheckSquare} /> Kotlin</li>

                                        <li><FontAwesomeIcon className="iconBullent" icon={faCheckSquare} /> Building our first Android App</li>
